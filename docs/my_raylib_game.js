...
var ASM_CONSTS = {
  94588: () => { if (document.fullscreenElement) return 1; },  
 94634: () => { return document.getElementById('canvas').width; },  
 94686: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94754: () => { document.exitFullscreen(); },  
 94781: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 94854: () => { if (document.fullscreenElement) return 1; },  
 94900: () => { return document.getElementById('canvas').width; },  
 ...
 95236: () => { return document.getElementById('canvas').width; },  
 95288: () => { return parseInt(document.getElementById('canvas').style.width); },  
 95356: () => { if (document.fullscreenElement) return 1; },  
 95402: () => { return document.getElementById('canvas').width; },  
 95454: () => { return screen.width; },  
 95479: () => { return window.innerWidth; },  
 95505: () => { return window.innerHeight; },  
 95532: () => { if (document.fullscreenElement) return 1; },  
 95578: () => { return document.getElementById('canvas').width; },  
 95630: () => { return screen.width; },  
 95655: () => { document.exitFullscreen(); },  
 95682: () => { if (document.fullscreenElement) return 1; },  
 95728: () => { return document.getElementById('canvas').width; },  
 95780: () => { return parseInt(document.getElementById('canvas').style.width); },  
 95848: () => { document.exitFullscreen(); },  
 95875: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 95933: () => { return screen.width; },  
 95958: () => { return screen.height; },  
 95984: () => { return window.screenX; },  
 96011: () => { return window.screenY; },  
 96038: () => { return window.devicePixelRatio; },  
 96074: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 96127: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 96198: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 96255: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 96511: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 96582: () => { if (document.fullscreenElement) return 1; },  
 96628: () => { return window.innerWidth; },  
 96654: () => { return window.innerHeight; },  
 96681: () => { if (document.pointerLockElement) return 1; }
};
